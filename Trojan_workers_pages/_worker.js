...
function gettrojanConfig(Pswd, hostName) {
  const wtrojanws = `trojan://${Pswd}\u0040104.26.0.0:8880?security=none&type=ws&host=${hostName}&path=%2F%3Fed%3D2560#${hostName}`;
  const ptrojanwstls = `trojan://${Pswd}\u0040104.26.0.0:8443?security=tls&type=ws&host=${hostName}&sni=${hostName}&fp=random&path=%2F%3Fed%3D2560#${hostName}`;
